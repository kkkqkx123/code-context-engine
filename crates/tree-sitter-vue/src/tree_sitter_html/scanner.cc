...
// Skip external C functions when included by Vue scanner to avoid symbol conflicts
// with the separate tree-sitter-html crate
#ifndef VUE_HTML_SCANNER_SKIP_EXTERN
...
#endif // VUE_HTML_SCANNER_SKIP_EXTERN
